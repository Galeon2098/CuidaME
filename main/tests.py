...
class EditProfileViewTestCase(TestCase):
    ...
    def test_edit_profile_cuidador(self):
        ...
        self.cuidador = Cuidador.objects.create(user=self.user, dni='12345678A', numero_seguridad_social='1234567890A', fecha_nacimiento='1990-01-01', formacion='Formacion', descripcion='Descripcion', tipo_publico_dirigido='Tipo de publico')
