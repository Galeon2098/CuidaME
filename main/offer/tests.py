...
class OffersTestCase(TestCase):
    def setUp(self):
        ...
        self.offer1 = Offer.objects.create(title="Oferta 1", offer_type="CO", client="DF", description="Descripción de la Oferta 1", price_per_hour=50, poblacion="Albaida del Aljarafe",address="Calle Velazquez 13, Sevilla", available=True, user=self.user)
        self.offer2 = Offer.objects.create(title="Oferta 2", offer_type="CU", client="DM", description="Descripción de la Oferta 2", price_per_hour=60, poblacion="Alcalá de Guadaíra",address="Calle Velazquez 13, Sevilla", available=True, user=self.user)
        self.offer3 = Offer.objects.create(title="Oferta 3", offer_type="TR", client="AN", description="Descripción de la Oferta 3", price_per_hour=40, poblacion="Alcalá del Río",address="Calle Velazquez 13, Sevilla", available=True, user=self.user)
        self.offer4 = Offer.objects.create(title="Oferta 4", offer_type="DO", client="NI", description="Descripción de la Oferta 4", price_per_hour=70, poblacion="Algámitas",address="Calle Velazquez 13, Sevilla", available=True, user=self.user)
        self.offer5 = Offer.objects.create(title="Oferta 5", offer_type="OT", client="OT", description="Descripción de la Oferta 5", price_per_hour=55, poblacion="Sevilla",address="Calle Velazquez 13, Sevilla", available=True, user=self.user)
        self.offer6 = Offer.objects.create(title="Oferta 6", offer_type="CO", client="DM", description="Descripción de la Oferta 6", price_per_hour=65, poblacion="Almadén de la Plata",address="Calle Velazquez 13, Sevilla", available=True, user=self.user)
        self.offer7 = Offer.objects.create(title="Oferta 7", offer_type="CU", client="AN", description="Descripción de la Oferta 7", price_per_hour=45, poblacion="Almensilla",address="Calle Velazquez 13, Sevilla", available=True, user=self.user)
